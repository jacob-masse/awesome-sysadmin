...
- [ftagent-lite](https://github.com/Flowtriq/ftagent-lite) - Lightweight open-source DDoS traffic monitor for Linux. Per-packet inspection detects attack types in real time, with PCAP capture and alerting. ([Source Code](https://github.com/Flowtriq/ftagent-lite)) `MIT` `Python`
...
- [NetHawk](https://github.com/Flowtriq/nethawk) - Real-time network traffic analysis TUI with bandwidth monitoring, protocol breakdown, top talkers and DDoS detection. ([Source Code](https://github.com/Flowtriq/nethawk)) `MIT` `Go`
