...
- [ftagent-lite](https://flowtriq.com) - Lightweight DDoS traffic monitor for network operators, with stdout output and no account required. ([Source Code](https://github.com/Flowtriq/ftagent-lite)) `MIT` `Python`
